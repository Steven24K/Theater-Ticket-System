...
*/
    ...
    if (isset($data->Id) and isset($data->Date) and isset($data->Time)) {
        $result = $connection->ExecuteQuery("UPDATE date_and_time SET Date = '$data->Date', Time = '$data->Time' WHERE Id = $data->Id");
