...
*/
    ...
    if (isset($data->theater_showId) and isset($data->date_and_timeId)) {
        $last_id = $connection->ExecuteQuery("INSERT INTO theater_show_date_and_time(theater_showId, date_and_timeId) VALUES ($data->theater_showId, $data->date_and_timeId)");
