...
*/
    ...
    if (isset($id) and $id !== "") {
        $result = $connection->GetQueryResult("SELECT * FROM theater_show_date_and_time WHERE Id = $id");
        ...
        $result = $connection->GetQueryResult("SELECT * FROM theater_show_date_and_time");
        $list = array();
