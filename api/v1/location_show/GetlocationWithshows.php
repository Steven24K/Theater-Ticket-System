...
*/
    ...
    if (isset($id) and $id !== "") {
        $result = $connection->GetQueryResult("SELECT * FROM location JOIN location_show ON location_show.locationId = location.Id JOIN show ON show.Id = location_show.showId WHERE Id = $id");
        ...
        $result = $connection->GetQueryResult("SELECT * FROM location JOIN location_show ON location_show.locationId = location.Id JOIN show ON show.Id = location_show.showId");
        $list = array();
