...
*/
    ...
    if ( isset($data->locationId) and isset($data->showId)) {
        $result = $connection->ExecuteQuery("UPDATE location_show SET locationId = $data->locationId, showId = $data->showId WHERE showId = $data->showId");
