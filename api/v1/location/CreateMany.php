    ...
    if (count($data) > 0) {
        ...
        foreach ($data as $record) {
            if (isset($data->Name) and isset($data->Capacity) and isset($data->Adress) and isset($data->PostalCode) and isset($data->City) and isset($data->GMapLink)) {
                $connection->ExecuteQuery("INSERT INTO location(Name, Capacity, Adress, PostalCode, City, GMapLink) VALUES ('$data->Name', $data->Capacity, '$data->Adress', '$data->PostalCode', '$data->City', '$data->GMapLink')");
                $insert_count += 1;
            } 
        } 
