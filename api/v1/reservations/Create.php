...
*/
    ...
    if (isset($data->amount) and isset($data->CheckedIn) and isset($data->PayementID)) {
        $last_id = $connection->ExecuteQuery("INSERT INTO reservations(amount, CheckedIn, PayementID) VALUES ($data->amount, $data->CheckedIn, '$data->PayementID')");
