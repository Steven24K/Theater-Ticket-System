...
*/
    ...
    if (isset($data->Id) and isset($data->amount) and isset($data->CheckedIn) and isset($data->PayementID)) {
        $result = $connection->ExecuteQuery("UPDATE reservations SET amount = $data->amount, CheckedIn = $data->CheckedIn, PayementID = '$data->PayementID' WHERE Id = $data->Id");
