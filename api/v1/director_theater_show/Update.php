...
*/
    ...
    if ( isset($data->directorId) and isset($data->theater_showId)) {
        $result = $connection->ExecuteQuery("UPDATE director_theater_show SET directorId = $data->directorId, theater_showId = $data->theater_showId WHERE theater_showId = $data->theater_showId");
