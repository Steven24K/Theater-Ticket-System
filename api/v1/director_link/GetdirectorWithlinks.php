...
*/
    ...
    if (isset($id) and $id !== "") {
        $result = $connection->GetQueryResult("SELECT * FROM director JOIN director_link ON director_link.directorId = director.Id JOIN link ON link.Id = director_link.linkId WHERE Id = $id");
        ...
        $result = $connection->GetQueryResult("SELECT * FROM director JOIN director_link ON director_link.directorId = director.Id JOIN link ON link.Id = director_link.linkId");
        $list = array();
