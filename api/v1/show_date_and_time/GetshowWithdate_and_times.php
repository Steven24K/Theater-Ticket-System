...
*/
    ...
    if (isset($id) and $id !== "") {
        $result = $connection->GetQueryResult("SELECT * FROM show JOIN show_date_and_time ON show_date_and_time.showId = show.Id JOIN date_and_time ON date_and_time.Id = show_date_and_time.date_and_timeId WHERE Id = $id");
        ...
        $result = $connection->GetQueryResult("SELECT * FROM show JOIN show_date_and_time ON show_date_and_time.showId = show.Id JOIN date_and_time ON date_and_time.Id = show_date_and_time.date_and_timeId");
        $list = array();
