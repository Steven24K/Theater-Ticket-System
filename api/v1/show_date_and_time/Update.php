...
*/
    ...
    if (isset($data->Id) and isset($data->showId) and isset($data->date_and_timeId)) {
        $result = $connection->ExecuteQuery("UPDATE show_date_and_time SET showId = $data->showId, date_and_timeId = $data->date_and_timeId WHERE Id = $data->Id");
