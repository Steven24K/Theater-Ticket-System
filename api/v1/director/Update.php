...
*/
    ...
    if (isset($data->Id) and isset($data->Name) and isset($data->Password) and isset($data->DateOfBirth) and isset($data->Bio)) {
        $result = $connection->ExecuteQuery("UPDATE director SET Name = '$data->Name', Password = '$data->Password', DateOfBirth = '$data->DateOfBirth', Bio = '$data->Bio' WHERE Id = $data->Id");
