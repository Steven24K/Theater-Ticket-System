...
*/
    ...
    if ( isset($data->actorId) and isset($data->linkId)) {
        $result = $connection->ExecuteQuery("UPDATE actor_link SET actorId = $data->actorId, linkId = $data->linkId WHERE linkId = $data->linkId");
