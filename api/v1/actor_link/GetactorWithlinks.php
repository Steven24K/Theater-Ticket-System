...
*/
    ...
    if (isset($id) and $id !== "") {
        $result = $connection->GetQueryResult("SELECT * FROM actor JOIN actor_link ON actor_link.actorId = actor.Id JOIN link ON link.Id = actor_link.linkId WHERE Id = $id");
        ...
        $result = $connection->GetQueryResult("SELECT * FROM actor JOIN actor_link ON actor_link.actorId = actor.Id JOIN link ON link.Id = actor_link.linkId");
        $list = array();
