...
*/
    ...
    $id = $_GET["reservationsId"];
    
    if (isset($id) and $id !== "") {
        $result = $connection->GetQueryResult("SELECT * FROM date_and_time_reservations WHERE reservationsId = $id");
        ...
        $result = $connection->GetQueryResult("SELECT * FROM date_and_time_reservations");
        $list = array();
