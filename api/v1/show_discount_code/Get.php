...
*/
    ...
    if (isset($id) and $id !== "") {
        $result = $connection->GetQueryResult("SELECT * FROM show_discount_code WHERE discount_codeId = $id");
        ...
        $result = $connection->GetQueryResult("SELECT * FROM show_discount_code");
        $list = array();
