...
*/
    ...
    if (isset($id) and $id !== "") {
        $result = $connection->GetQueryResult("SELECT * FROM show JOIN show_discount_code ON show_discount_code.showId = show.Id JOIN discount_code ON discount_code.Id = show_discount_code.discount_codeId WHERE Id = $id");
        ...
        $result = $connection->GetQueryResult("SELECT * FROM show JOIN show_discount_code ON show_discount_code.showId = show.Id JOIN discount_code ON discount_code.Id = show_discount_code.discount_codeId");
        $list = array();
