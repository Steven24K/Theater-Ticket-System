...
*/
    ...
    if ( isset($data->showId) and isset($data->discount_codeId)) {
        $result = $connection->ExecuteQuery("UPDATE show_discount_code SET showId = $data->showId, discount_codeId = $data->discount_codeId WHERE discount_codeId = $data->discount_codeId");
