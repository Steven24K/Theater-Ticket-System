...
*/
    ...
    if (isset($id) and $id !== "") {
        $result = $connection->GetQueryResult("SELECT * FROM director JOIN director_show ON director_show.directorId = director.Id JOIN show ON show.Id = director_show.showId WHERE Id = $id");
        ...
        $result = $connection->GetQueryResult("SELECT * FROM director JOIN director_show ON director_show.directorId = director.Id JOIN show ON show.Id = director_show.showId");
        $list = array();
