...
*/
    ...
    if ( isset($data->directorId) and isset($data->showId)) {
        $result = $connection->ExecuteQuery("UPDATE director_show SET directorId = $data->directorId, showId = $data->showId WHERE showId = $data->showId");
