...
*/
    ...
    if (isset($data->Id) and isset($data->showId) and isset($data->actorId)) {
        $result = $connection->ExecuteQuery("UPDATE show_actor SET showId = $data->showId, actorId = $data->actorId WHERE Id = $data->Id");
