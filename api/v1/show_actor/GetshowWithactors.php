...
*/
    ...
    if (isset($id) and $id !== "") {
        $result = $connection->GetQueryResult("SELECT * FROM show JOIN show_actor ON show_actor.showId = show.Id JOIN actor ON actor.Id = show_actor.actorId WHERE Id = $id");
        ...
        $result = $connection->GetQueryResult("SELECT * FROM show JOIN show_actor ON show_actor.showId = show.Id JOIN actor ON actor.Id = show_actor.actorId");
        $list = array();
