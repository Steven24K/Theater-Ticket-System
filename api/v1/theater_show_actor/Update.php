...
*/
    ...
    if (isset($data->Id) and isset($data->theater_showId) and isset($data->actorId)) {
        $result = $connection->ExecuteQuery("UPDATE theater_show_actor SET theater_showId = $data->theater_showId, actorId = $data->actorId WHERE Id = $data->Id");
