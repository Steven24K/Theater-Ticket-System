...
*/
    ...
    if (isset($id) and $id !== "") {
        $result = $connection->GetQueryResult("SELECT * FROM theater_show JOIN theater_show_actor ON theater_show_actor.theater_showId = theater_show.Id JOIN actor ON actor.Id = theater_show_actor.actorId WHERE Id = $id");
        ...
        $result = $connection->GetQueryResult("SELECT * FROM theater_show JOIN theater_show_actor ON theater_show_actor.theater_showId = theater_show.Id JOIN actor ON actor.Id = theater_show_actor.actorId");
        $list = array();
