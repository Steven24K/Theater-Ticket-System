...
*/
    ...
    if (isset($data->Id) and isset($data->Email) and isset($data->FirstName) and isset($data->LastName) and isset($data->Insertion) and isset($data->reg_date)) {
        $result = $connection->ExecuteQuery("UPDATE customer SET Email = '$data->Email', FirstName = '$data->FirstName', LastName = '$data->LastName', Insertion = '$data->Insertion', reg_date = '$data->reg_date' WHERE Id = $data->Id");
