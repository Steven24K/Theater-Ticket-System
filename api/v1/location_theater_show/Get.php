...
*/
    ...
    if (isset($id) and $id !== "") {
        $result = $connection->GetQueryResult("SELECT * FROM location_theater_show WHERE theater_showId = $id");
        ...
        $result = $connection->GetQueryResult("SELECT * FROM location_theater_show");
        $list = array();
